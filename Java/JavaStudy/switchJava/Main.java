package Java.JavaStudy.switchJava;
...
public class Main {
  ...
  * 　名前：alice
  * 　パスワード：alice123
  * 本問題では、すべての定数(合計６種類)を使いつつ、if文の使い方に
  * 慣れていきましょう！
  * 問① 〜 問⑤まで回答お願いします！
  */
    ...
    public static void main(String[] args) {
        // 以下の変数「name」「pass」を使用して、②〜⑤の条件を満たす処理を
        //記述してください。
        ...
        // ② 「name」の値が「USER_NAME」と等しく、「 pass 」の値が
        // 「USER_PASSWORD」と等しい場合。
